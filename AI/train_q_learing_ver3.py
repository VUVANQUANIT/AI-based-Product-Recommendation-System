...
# API trả về gợi ý (hỗ trợ GET và POST)
...
def recommend():
    ...
    # ε-greedy: Khám phá hoặc khai thác
    if np.random.rand() < epsilon:
        # Khám phá: Chọn ngẫu nhiên đủ sản phẩm cho ít nhất 2 trang (36)
...
if __name__ == '__main__':
    app.run(host='127.0.0.1', port=5000)#bản chính